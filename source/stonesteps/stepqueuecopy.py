        ...
        for observer in observers:
            ...
            for obspath in observations[observer]:
                ...
                text = (
                    ...
                    f'pythonpath = /data/scripts/DataReduction/source\n'
                    f'pipeconf = /data/scripts/DataReduction/config/pipeconf_SEO.txt\n'
                    f'/data/scripts/DataReduction/config/dconf_stars.txt\n'
                    f'pipemode = seo_server\n'
                    f'loglevel = DEBUG\n'
                    f'logfile = /data/scripts/DataReduction/PipeLineLog.txt\n'
